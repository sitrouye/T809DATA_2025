...
* Computer Exercise 1: Supervised learning with Naive Bayes and Decision Trees
    * Assignment 1: [Decision Trees](01_decision_trees/README.md)
    * Assignment 2: [Classification](02_classification/README.md)
* Computer Exercise 2: Neural Networks and Backprop
    * Assignment 3: [Neural Networks and Backpropagation](03_backprop/README.md)
* Computer Exercise 3: Unsupervised learning with Kmeans and PCA
    * Assignment 4: [Principal Component Analysis](04_PCA/README.md)
    * Assignment 5: [K-means Clustering](05_K_means/README.md)
